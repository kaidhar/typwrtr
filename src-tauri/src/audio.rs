...
impl AudioRecorder {
    ...
    pub fn start(&mut self, mic_name: &str) -> Result<(), String> {
        ...
        println!("[typwrtr] Mic config: {}Hz, {} channels", sample_rate, channels);
        ...
        println!("[typwrtr] Audio recording started");
        Ok(())
    }
    ...
    pub fn stop_and_save(&mut self, output_path: &PathBuf) -> Result<PathBuf, String> {
        ...
        println!("[typwrtr] Resampled to {} samples at 16kHz", resampled.len());
        ...
        println!("[typwrtr] WAV saved to {:?}", output_path);
